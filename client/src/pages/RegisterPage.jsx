...
export default function RegisterPage() {
  ...
  const orgLabel = normalizedRole === 'professional' ? 'Current Company / Expertise' : 'University / College'
  const orgPlaceholder =
    normalizedRole === 'professional' ? 'e.g., Senior Engineer at Google' : 'e.g., IIT Bombay'
    ...
    <GlassShell>
      ...
      <form className="space-y-5" onSubmit={onSubmit}>
        <label className="block space-y-2">
          <div className="text-[13px] font-bold text-[#86868B] ml-1">Full Name</div>
          <input
        ...
        <label className="block space-y-2">
          <div className="text-[13px] font-bold text-[#86868B] ml-1">Email Address</div>
          <input
            className="w-full rounded-2xl border border-white/5 bg-white/5 px-5 py-4 text-sm outline-none transition-all placeholder:text-white/20 focus:border-[#0071E3]/50 focus:bg-white/10"
        ...
        <label className="block space-y-2">
          <div className="text-[13px] font-bold text-[#86868B] ml-1">{orgLabel}</div>
          <input
            className="w-full rounded-2xl border border-white/5 bg-white/5 px-5 py-4 text-sm outline-none transition-all placeholder:text-white/20 focus:border-[#0071E3]/50 focus:bg-white/10"
